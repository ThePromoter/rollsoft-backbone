...
//                partialDeps = [];
            ...
            function getExternalDeps( nodes ) {
              ...
              var defaultHelpers = ["helperMissing", "blockHelperMissing", "if", "unless", "with"].concat(config.hbs.defaultHelpers || []);
              return {
            ...
            function fetchAndRegister(langMap){
              fetchText(path, function (text) {
                  ...
                  var mapping = false; //disableI18n? false : _.extend( langMap, config.localeMapping ),
                      prec = Handlebars.precompile( text, mapping, { originalKeyFallback: (config.hbs || {}).originalKeyFallback });
